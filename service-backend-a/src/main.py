...
logger.info(f"Environtment Value: SERVICE_BACKEND_B_URL: {os.getenv("SERVICE_BACKEND_B_URL")}")

if os.getenv("SERVICE_BACKEND_B_URL") is None:
    logger.warning("Environtment Value: SERVICE_BACKEND_B_URL is null")
